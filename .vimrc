...
set autoindent 				"Preserver current indent on new lines
set textwidth=78			"Wrap at this column
set backspace=indent,eol,start		"Make backspaces delete sensibly

set tabstop=4				"Intention levels every four columns
...
"http://perltricks.com/article/133/2014/11/10/Boost-your-Perl-productivity-with-auto-compile-checking
autocmd BufWritePost *.pm,*.t,*.pl echom system("perl -Ilib -c " . expand('%:p'))

"NEW - https://drive.google.com/file/d/0Bx3f0gFZh5JqTktJVFhlVGItR2s/view https://github.com/thoughtstream/Damian-Conway-s-Vim-Setup/tree/master/plugin
...
highlight Comment term=bold ctermfg=blue
...
iab udp use Data::Printer;<CR>p ;<LEFT>
